...
gnome-terminal\
    --tab\
        --title="iu_redirect" -- bash -c "source /home/penguin37/companion/rem_chat/predictors/rem_iu/bin/activate; cd /home/penguin37/companion/rem_chat/predictors/iu; python run_iu_server_handler_dev.py 9209; $SHELL"

gnome-terminal\
    --tab\
        --title="blender_bot" -- bash -c "source /home/penguin37/companion/rem_chat/rem_env/bin/activate; cd /home/penguin37/companion/rem_chat/ParlAI; python projects/image_chat/server_updated_blenderbot_dev.py -mf zoo:blenderbot2/blenderbot2_400M/model --knowledge-access-method classify --search-server 0.0.0.0; $SHELL"

gnome-terminal\
    --tab\
        --title="question_sim" -- bash -c "cd /home/penguin37/companion/rem_chat/VQA_enhancement; source sim_py3/bin/activate; python web_serv_sim_dev.py 9110"
